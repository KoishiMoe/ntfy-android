...
class Repository(private val sharedPrefs: SharedPreferences, database: Database) {
    ...
    fun getShareDefaultMessageEnabled(): Boolean {
        return sharedPrefs.getBoolean(SHARED_PREFS_SHARE_DEFAULT_MESSAGE_ENABLED, true) // Enabled by default
    }

    fun setShareDefaultMessageEnabled(enabled: Boolean) {
        sharedPrefs.edit {
            putBoolean(SHARED_PREFS_SHARE_DEFAULT_MESSAGE_ENABLED, enabled)
        }
    }
    ...
    companion object {
        ...
        const val SHARED_PREFS_SHARE_DEFAULT_MESSAGE_ENABLED = "ShareDefaultMessage"
